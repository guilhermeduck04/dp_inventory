...
------------------ COLETE/FUNção
    ...
    --    ["GADGET_PARACHUTE"] = { index = "parachute", nome = "Paraquedas", type = "equipar" },
        ...
        ["WEAPON_SPECIALCARBINE"] = { index = "parafal", nome = "Parafal", type = "equipar"},
        ...
        ["WEAPON_HEAVYSNIPER_MK2"] = { index = "Sniper", nome = "Sniper", type = "equipar"},
            ...
            ["AMMO_SPECIALCARBINE"] = { index = "rifleammo", nome = "M.Parafal", filtro = "arma", type = "recarregar", funcao = false, descricao = "Recarregue as munições da sua arma" },
